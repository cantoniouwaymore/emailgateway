/**
 * Markdown Viewer Generator
 * 
 * Generates a beautiful HTML page for viewing markdown documentation
 * with syntax highlighting, table of contents, and mermaid diagram support.
 */
