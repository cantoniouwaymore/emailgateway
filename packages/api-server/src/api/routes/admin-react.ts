...
export async function adminReactRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/admin/templates/editor/:templateKey', spaHandler);
  fastify.get('/admin/messages', spaHandler);
  fastify.get('/admin/messages/:messageId', spaHandler);

  console.log('✅ React admin routes registered at /admin');
}
