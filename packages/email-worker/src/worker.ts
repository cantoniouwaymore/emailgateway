...
import { prisma } from '../../api-server/src/db/client';
import { MessageStatus } from '@prisma/client';
import { TemplateEngine } from '../../api-server/src/templates/engine';
import { ProviderManager } from '../../api-server/src/providers/manager';
import { EmailJobData } from './producer';
import { logger, createTraceId } from '../../api-server/src/utils/logger';
import { retryCount, emailsSentTotal, emailsFailedTotal } from '../../api-server/src/utils/metrics';
...
export class EmailWorker {
  ...
  constructor() {
    ...
    // Initialize template engine with correct path to api-server templates
    const templatesPath = join(process.cwd(), '..', 'api-server', 'src', 'templates');
